...
func TestIsFoodDangerous(t *testing.T) {
	...
	tests := []struct {
		...
		{"Food far from enemy", Coord{X: 0, Y: 10}, true},
		...
		// Food at (5,2): dist from us=7, dist from enemy=3 - enemy closer = dangerous
		{"Food 3 spaces from enemy (enemy closer)", Coord{X: 5, Y: 2}, true},
